      ...
      <div className="article-root">
        <section className="article-main">
          ...
          <p>
            ...
            routes and returning streetcar service to Broadview Station.
          </p>
          <p>
            In a news release issued Friday, the transit company said it is
            increasing capacity and frequency on the 29 Dufferin route on
            Saturday nights.
          </p>
          <p>
          ...
          <p>
            ...
            include, 41 Keele, 125 Drewry, 935 Jane Express, 941 Keele Express
            and 960 Steeles West Express. Routes that will see less frequent
            buses at certain times include 17 Birchmount and 900 Airport
            Express.
          </p>
          <p>
          ...
          <p>
            Also, as a result of work beginning to replace certain water mains
            and streetcar tracks along King Street West, between Shaw and
            Dufferin, service in the area on the 63 Ossington, 501 Queen,
            504/304 King and 508 Lake Shore routes will be affected.
          </p>
          <p>
