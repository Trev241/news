      ...
      <div className="home">
        ...
        <section className="latest-news-section">
          ...
          <div className="news-item">
            <h3>
              What next for Putin? After Navalny's death, many fear what leader
              will move on to
            </h3>
            <p>
              With Ukraine retreating and western sanctions having little
              impact, the Russian president is growing bolder and may embark on
              more reckless moves
            </p>
          </div>
          <div className="news-item">
